  ...
  <>
    <section>
      ...
      <div className="container mt-8 grid md:grid-cols-3 gap-4">
        {/* {recipes.length && recipes.map((recipe)=>  <Card ID={recipe.id} key={recipe.id} dishTypes={recipe.dishTypes} recipe={recipe.title} time={recipe.readyInMinutes} imgSrc={recipe.image} /> )} */}
